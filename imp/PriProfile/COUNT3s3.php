...
{ 
$Csem = $_POST['csem'];
$RESULT = $connect->query("SELECT count(*) FROM student WHERE cursem= '$Csem' ");
$data=$RESULT->fetch_assoc();
echo "<br><h3>Number of Students in sem '$Csem'&nbsp:&nbsp";
echo $data['count(*)'];
echo "</h3>"; 
$sql = $connect->query("SELECT * FROM student WHERE cursem= '$Csem'");
