...
<html lang="en">
    ...
    <head>
        ...
        <title>PDPM IIITDM Jabalpur Home</title>
        <!-- Bootstrap Core CSS -->
    ...
    <body id="page-top">
        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:brown">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="http://www.iiitdmj.ac.in">PDPM IIITDM JABALPUR </a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a class="page-scroll" href="../HODProfile/index.php">Company Login</a>
                        </li>
        ...
        <header>
            <div class="header-content">
                <div class="header-content-inner">
                    <h1> PLACEMENT CELL IIITDM JABALPUR</h1>
                    <hr>
			...
			<div class="container">
				<div class="col-md-3 ftr_navi ftr">
					...
					<ul>
						...
						<li>
							<a href="../HODProfile/index.php">Company Login</a>
						</li>
						<li>
				...
				<div class="col-md-3 get_in_touch ftr">
					...
					<p>Dumna Airport Road,</br>
                        Jabalpur-482005, Madhya Pradesh,</br> India</p>
					<p> +91 761 2632549</p>
					<a href="mailto: placement@iiitdmj.ac.in"> placement@iiitdmj.ac.in</a>
				</div>
				<div class="col-md-3 ftr-logo">
					<p>Copyright &copy; 2018 PDPM IIITDM Jabalpur-SOE | Developed by
              <a href="#" target="_parent">SSH  Technologies</a>
				</div>
