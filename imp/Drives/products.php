...
<html>
	<head>
		...
		<title>IIITDM JABALPUR | Campus Drives</title>
		<meta name="viewport"
					...
					<div class="top-nav">
						...
						<ul class="nav1">
							...
							<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">PDPM IIITDM<i>Goto Placement Homepage</i></a>
							</li>
							<li class="hvr-sweep-to-bottom">
				...
				<div class="products-top-grids wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					...
					<div class="col-md-4 products-grid">
						...
						<div class="products-text">
							<h4>Vassar Labs</h4>
							<p></p>
							<a class="btn btn-primary btn-lg see-button hvr-shutter-out-horizontal" href="http://www.vassarlabs.com/" role="button">See More</a>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
				...
				<div class="products-top-grids wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<div class="col-md-4 products-grid">
						...
						<div class="products-text">
							<h4>Capgemini</h4>
							<p></p>
							<a class="btn btn-primary btn-lg see-button hvr-shutter-out-horizontal" href="https://www.capgemini.com/in-en/" role="button">See More</a>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="col-md-4 products-grid">
					...
					<div class="col-md-4 products-grid">
						...
						<div class="products-text">
							<h4>Zolo</h4>
							<p></p>
							<a class="btn btn-primary btn-lg see-button hvr-shutter-out-horizontal" href="https://zolostays.com/" role="button">See More</a>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">PDPM IIITDM JABALPUR</h6>
					<h4>
		...
		<div class="copyright">
			...
			<div class="container">
				<div class="copyright-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					 <p>Copyright &copy; 2018 PDPM IIITDM Jabalpur-SOE | Developed by
              <a href="http://znumerique.azurewebsites.net" target="_parent">SSH Technologies</a>
				</div>
