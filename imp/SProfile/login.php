      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
          <ul>
            ...
            <li>
              <a href="#"><i class="fa fa-sliders fa-fw"></i>Training papers</a>
            </li>
            <li>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="square"></div>
              <h2 class="templatemo-inline-block">Welcome to IIITDMJ</h2>
              <hr>
            ...
            <div class="templatemo-content-widget white-bg col-1 text-center">
              ...
              <h5 class="text-uppercase margin-bottom-10">Projects (DBMS)</h5>
              ...
              <div class="templatemo-content-widget white-bg">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p>Brace yourself for the Events that will take ur breath away. Get Started and be a Part of IIITDMJ Family</p>
                  </div>
                </div>
              </div>
            </div>
